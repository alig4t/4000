          ...
          <tr>
            <td colspan="15" style="padding: 0 !important;">
              <div class="collapse" id="collapseWord{{$index}}">
                ...
                <div class="my-1">
                    <div class="w-100 infobox">
                      <span class="badge text-bg-warning">مثال سوم :</span>
                    </div>
                    <div class="section-box">
                      <div class="row m-0" dir="ltr">
                        <p class="col-12 col-md-6 text-start" > {{$word->example3}}</p>
                        <p class="col-12 col-md-6" dir="rtl"> {{$word->example_trs3}}</p>
                      </div>
                  </div>
                </div>
                @endif
                ...
                <div class="my-1">
                    <div class="w-100 infobox">
                      <span class="badge text-bg-warning">مثال چهارم :</span>
                    </div>
                    <div class="section-box">
                      <div class="row m-0" dir="ltr">
                        <p class="col-12 col-md-6 text-start" > {{$word->example4}}</p>
                        <p class="col-12 col-md-6" dir="rtl"> {{$word->example_trs4}}</p>
                      </div>
                  </div>
                </div>
                @endif
                ...
                <div class="my-1">
                    <div class="w-100 infobox">
                      <span class="badge text-bg-warning">مثال پنجم :</span>
                    </div>
                    <div class="section-box">
                      <div class="row m-0" dir="ltr">
                        <p class="col-12 col-md-6 text-start" > {{$word->example5}}</p>
                        <p class="col-12 col-md-6" dir="rtl"> {{$word->example_trs5}}</p>
                      </div>
                  </div>
                </div>
                @endif
